...
import { check, drop, exportRaw, generate, migrate, migrateFromJournalCommand, pull, push, studio, up } from './schema';
...
run([generate, migrate, pull, push, studio, up, check, drop, migrateFromJournalCommand, exportRaw, ...legacy], {
	name: 'wizzle',
	version: version,
});
